...
public class RunGameView extends JPanel {
    ...
    public static final String Health_Point_3_IMAGE_FILE = "Health-Point_3.png";
    public static final String Health_Point_2_IMAGE_FILE = "Health-Point_2.png";
    public static final String Health_Point_1_IMAGE_FILE = "Health-Point_1.png";
    public static final String Fast_Reloading_IMAGE_FILE = "Fast-Reloading.png";
    public static final String POWER_UP_BAR_IMAGE_FILE = "Power-up-bar.png";
