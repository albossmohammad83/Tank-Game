...
public class LoseEndMenuView extends JPanel {
    public static final Dimension SCREEN_DIMENSIONS = new Dimension(510, 550);
    private static final String START_MENU_IMAGE_FILE = "lose.png";
    ...
    public LoseEndMenuView(String startButtonText, ActionListener startMenuListener) {
